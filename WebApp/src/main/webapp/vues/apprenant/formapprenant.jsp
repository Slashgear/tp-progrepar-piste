        ...
        <form class="form-horizontal">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="number" class="form-control" id="idApprenant" placeholder="Num�ro de l'apprenant"
                               value="${idApprenant}">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control" id="prenomApprenant" placeholder="Pr�nom de l'apprenant"
