...
CREATE TABLE IF NOT EXISTS `inscription` (
  ...
  KEY `NUMAPPRENANT_K_3` (`NUMAPPRENANT`),
  KEY `NUMJEU_K_3` (`NUMJEU`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
ALTER TABLE `inscription`
 ADD FOREIGN KEY (`NUMAPPRENANT`) REFERENCES `apprenant` (`NUMAPPRENANT`),
 ADD FOREIGN KEY (`NUMJEU`) REFERENCES `jeu` (`NUMJEU`);